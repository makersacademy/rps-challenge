...
describe Game do
  ...
  context "Get computer choice" do
    it "can get computer's choice" do
      expect([:Rock, :Paper, :Scissors]).to include(game_rock.get_computer_choice)
    end
