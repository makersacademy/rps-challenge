...
describe Turn do
  ...
  let(:options) {{"player_name" => "Tim", "player_shape" => :rock, "opponent_shape" => :scissors}}

describe '#player_name' do
  it 'returns player name' do
  expect(turn.player_name).to eq "Tim"
...
context 'end game' do
  ...
  subject(:draw_turn) {described_class.new(draw_options)}
    ...
    let(:lose_options) { {"player_name" => "Tim", "player_shape" => :rock, "opponent_shape" => :paper} }
    let(:draw_options) { {"player_name" => "Tim", "player_shape" => :rock, "opponent_shape" => :rock} }
