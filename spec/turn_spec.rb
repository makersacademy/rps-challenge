...
describe Turn do
    ...
    let(:options) { {"player_name" => "Daniil", "player_shape" => :rock, "opponent_shape" => :scissors} }

    describe '#player_name' do
        it 'returns player name' do
            expect(turn.player_name).to eq 'Daniil'
        end
    end
    ...
    context 'end game' do
        ...
        describe '#lose?' do
            it 'returns ture if player_shape is :rock and opponent_shape is :paper' do
