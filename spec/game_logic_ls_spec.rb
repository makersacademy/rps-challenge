...
RSpec.describe GameLogic do
  ...
  describe '- Get an AI selection' do
    it '- check selection is valid' do
      20.times {
        expect(['rock', 'paper', 'scissors', 'lizard', 'spock']).to include(GameLogic.ai_selection)
      }
    end
  end
