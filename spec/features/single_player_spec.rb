...
feature 'Feature Test Single - start single player game' do
  scenario 'submitting names' do
    submit_name
    expect(page).to have_content "Get ready to play Rosie!"
  end
end
feature 'Feature Test Single - choosing weapon' do
...
feature 'Feature Test Single - win/lose game against computer' do
