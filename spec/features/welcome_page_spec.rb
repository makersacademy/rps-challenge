describe 'Home page', type: :feature do
  ...
  it 'has a text box for users name - single player' do
    expect(page.has_xpath?('//form[@action="/new_game"]/input[@name="player_name"]')).to eq(true)
  end

  it 'has a button for starting a game - single_player' do
    expect(page.has_xpath?('.//form[@action="/new_game"]/button[@type="submit"]')).to eq(true)
  end
  ...
  it 'has a text box for opponents name' do
    expect(page.has_xpath?('.//form[@action="/new_game"]/input[@name="opponent_name"]')).to eq(true)
  end
