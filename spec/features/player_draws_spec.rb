feature 'The player should draw' do
  context "The player chooses Rock and should draw" do
  ...
  context "The player chooses Paper and should draw" do
    scenario "player draws" do
      sign_in_and_press_submit
      loop do
  ...
  context "The player chooses Scissors and should draw" do
    scenario "player draws" do
      sign_in_and_press_submit
      loop do
