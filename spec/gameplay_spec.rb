...
describe Gameplay do 
  ...
  context 'ending the game' do 
    describe '#win?' do 
      it 'returns false when player_choice is rock and opponent choice is paper' do 
        expect(subject.win?).to eq false
      end 

      it 'returns false when player_choice is scissors and opponent choice is rock' do 
        expect(subject.win?).to eq false
      end 

      it 'returns true when player_choice is rock and opponent choice is scissors' do 
        expect(subject.win?).to eq true
      end 

      it 'returns true when player_choice is scissors and opponent choice is paper' do 
        expect(subject.win?).to eq true
      end 
